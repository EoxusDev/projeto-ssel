        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('novoesporte') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('estrutura') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="estrutura" type="estrutura" rows="3" cols="50" class="form-control" name="estrutura" required></textarea>
                        ...
                        <div class="form-group{{ $errors->has('atividades') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="atividades" type="atividades" rows="3" cols="50" class="form-control" name="atividades" required></textarea>
                        ...
                        <div class="form-group{{ $errors->has('endereco') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="endereco" type="endereco" class="form-control" name="endereco" required>
